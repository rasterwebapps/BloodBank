package com.bloodbank.reportingservice.config;
...
public class RabbitMQConfig {
    ...
    public static final String DONATION_COMPLETED_QUEUE = "reporting.donation.completed.queue";
    public static final String CAMP_COMPLETED_QUEUE = "reporting.camp.completed.queue";
    public static final String TEST_RESULT_AVAILABLE_QUEUE = "reporting.test.result.available.queue";
    public static final String UNIT_RELEASED_QUEUE = "reporting.unit.released.queue";
    public static final String BLOOD_STOCK_UPDATED_QUEUE = "reporting.blood.stock.updated.queue";
    public static final String STOCK_CRITICAL_QUEUE = "reporting.stock.critical.queue";
    public static final String UNIT_EXPIRING_QUEUE = "reporting.unit.expiring.queue";
    public static final String BLOOD_REQUEST_CREATED_QUEUE = "reporting.blood.request.created.queue";
    public static final String BLOOD_REQUEST_MATCHED_QUEUE = "reporting.blood.request.matched.queue";
    public static final String EMERGENCY_REQUEST_QUEUE = "reporting.emergency.request.queue";
    public static final String TRANSFUSION_COMPLETED_QUEUE = "reporting.transfusion.completed.queue";
    public static final String TRANSFUSION_REACTION_QUEUE = "reporting.transfusion.reaction.queue";
    public static final String INVOICE_GENERATED_QUEUE = "reporting.invoice.generated.queue";
    public static final String RECALL_INITIATED_QUEUE = "reporting.recall.initiated.queue";
    ...
    public Binding donationCompletedBinding(Queue donationCompletedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(donationCompletedQueue).to(bloodbankExchange)
    ...
    public Binding campCompletedBinding(Queue campCompletedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(campCompletedQueue).to(bloodbankExchange)
                .with(EventConstants.CAMP_COMPLETED);
    }

    @Bean
    public Binding testResultAvailableBinding(Queue testResultAvailableQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(testResultAvailableQueue).to(bloodbankExchange)
    ...
    public Binding unitReleasedBinding(Queue unitReleasedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(unitReleasedQueue).to(bloodbankExchange)
    ...
    public Binding bloodStockUpdatedBinding(Queue bloodStockUpdatedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(bloodStockUpdatedQueue).to(bloodbankExchange)
    ...
    public Binding stockCriticalBinding(Queue stockCriticalQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(stockCriticalQueue).to(bloodbankExchange)
    ...
    public Binding unitExpiringBinding(Queue unitExpiringQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(unitExpiringQueue).to(bloodbankExchange)
                .with(EventConstants.UNIT_EXPIRING);
    }

    @Bean
    public Binding bloodRequestCreatedBinding(Queue bloodRequestCreatedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(bloodRequestCreatedQueue).to(bloodbankExchange)
    ...
    public Binding bloodRequestMatchedBinding(Queue bloodRequestMatchedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(bloodRequestMatchedQueue).to(bloodbankExchange)
    ...
    public Binding emergencyRequestBinding(Queue emergencyRequestQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(emergencyRequestQueue).to(bloodbankExchange)
    ...
    public Binding transfusionCompletedBinding(Queue transfusionCompletedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(transfusionCompletedQueue).to(bloodbankExchange)
                .with(EventConstants.TRANSFUSION_COMPLETED);
    }

    @Bean
    public Binding transfusionReactionBinding(Queue transfusionReactionQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(transfusionReactionQueue).to(bloodbankExchange)
                .with(EventConstants.TRANSFUSION_REACTION);
    }

    @Bean
    public Binding invoiceGeneratedBinding(Queue invoiceGeneratedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(invoiceGeneratedQueue).to(bloodbankExchange)
                .with(EventConstants.INVOICE_GENERATED);
    }

    @Bean
    public Binding recallInitiatedBinding(Queue recallInitiatedQueue, TopicExchange bloodbankExchange) {
        return BindingBuilder.bind(recallInitiatedQueue).to(bloodbankExchange)
                .with(EventConstants.RECALL_INITIATED);
    }
